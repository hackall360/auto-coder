...
- Use LLMs to [respond in chats](./llm-prediction/chat-completion) or predict [text completions](./llm-prediction/completion)
- Define functions as tools, and turn LLMs into [autonomous agents](./agent/act) that run completely locally
- [Load](./model-management/loading), [configure](./llm-prediction/parameters), and [unload](./model-management/loading) models from memory
