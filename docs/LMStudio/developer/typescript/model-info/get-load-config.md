...
[through the server UI](/docs/LMStudio/app/advanced/per-model) or [through the API](/docs/LMStudio/developer/typescript/model-management/loading).
...
```lms_protip
Context length is a special case that [has its own method](/docs/LMStudio/developer/typescript/model-info/get-context-length).
```
