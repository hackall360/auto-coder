...
<!--
Learn more about the `.load_new_instance()` method and the parameters it accepts in the [API Reference](../api-reference/model).
-->
...
after the last request until the model unloads. See [Idle TTL](/docs/LMStudio/app/api/ttl-and-auto-evict) for more on this.
